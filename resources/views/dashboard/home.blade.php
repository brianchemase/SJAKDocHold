...
@section('content')
		...
		<div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <h1 class="app-page-title">SJAK Doc Share Dashboard</h1>
			    
			    <div class="app-card alert alert-dismissible shadow-sm mb-4 border-left-decoration" role="alert">
				    <div class="inner">
					    <div class="app-card-body p-3 p-lg-4">
						    <h3 class="mb-3">Quick Intro</h3>
						    <div class="row gx-5 gy-3">
						        <div class="col-12 col-lg-12">
							        
							        <div>This platform is ment for users to upload documents for the signatories to preview and have visibility before approoving any request online. <br>
										The users will upload the documents in the format of PDFs into the system. Each user is encouranged to use their own credentials for any upload or approval. <br>
										The system maintains an audit trail of every request/transaction on the system.  
									</div>
							    </div><!--//col-->
			    ...
			    <div class="row g-4 mb-4">
				    <div class="col-6 col-lg-3">
					    <div class="app-card app-card-stat shadow-sm h-100">
						    <div class="app-card-body p-3 p-lg-4">
							    ...
							    <div class="stats-figure">{{ number_format($totalUploads) }}</div>
				    ...
				    <div class="col-6 col-lg-3">
					    <div class="app-card app-card-stat shadow-sm h-100">
						    <div class="app-card-body p-3 p-lg-4">
							    <h4 class="stats-type mb-1">Pending Approvals</h4>
							    <div class="stats-figure">{{ number_format($pendingCount) }}</div>
							    <div class="stats-meta text-success">
				    ...
				    <div class="col-6 col-lg-3">
					    <div class="app-card app-card-stat shadow-sm h-100">
						    <div class="app-card-body p-3 p-lg-4">
							    ...
							    <div class="stats-figure">{{ number_format($approvedCount) }}</div>
				    ...
				    <div class="col-6 col-lg-3">
					    <div class="app-card app-card-stat shadow-sm h-100">
						    <div class="app-card-body p-3 p-lg-4">
							    <h4 class="stats-type mb-1">On Review</h4>
							    <div class="stats-figure">{{ number_format($onReviewCount) }}</div>
							    <div class="stats-meta">Review</div>
						    </div><!--//app-card-body-->
						    <a class="app-card-link-mask" href="#"></a>
					    </div><!--//app-card-->
				    </div><!--//col-->
